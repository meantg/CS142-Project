...
(function () {
   ...
   var photo1 = { _id: "57231f1a30e4351f4e9f4bdd", date_time: "2012-08-30 10:44:23", file_name: "ouster.jpg", user_id: jo._id, viewer: [] };
   var photo2 = { _id: "57231f1a30e4351f4e9f4bde", date_time: "2009-09-13 20:00:00", file_name: "malcolm2.jpg", user_id: im._id, viewer: [] };
   var photo3 = { _id: "57231f1a30e4351f4e9f4bdf", date_time: "2009-09-13 20:05:03", file_name: "malcolm1.jpg", user_id: im._id, viewer: [] };
   var photo4 = { _id: "57231f1a30e4351f4e9f4be0", date_time: "2013-11-18 18:02:00", file_name: "ripley1.jpg", user_id: er._id, viewer: [] };
   var photo5 = { _id: "57231f1a30e4351f4e9f4be1", date_time: "2013-09-20 17:30:00", file_name: "ripley2.jpg", user_id: er._id, viewer: [] };
   var photo6 = { _id: "57231f1a30e4351f4e9f4be2", date_time: "2009-07-10 16:02:49", file_name: "kenobi1.jpg", user_id: rk._id, viewer: [] };
   var photo7 = { _id: "57231f1a30e4351f4e9f4be3", date_time: "2010-03-18 23:48:00", file_name: "kenobi2.jpg", user_id: rk._id, viewer: [] };
   var photo8 = { _id: "57231f1a30e4351f4e9f4be4", date_time: "2010-08-30 14:26:00", file_name: "kenobi3.jpg", user_id: rk._id, viewer: [] };
   var photo9 = { _id: "57231f1a30e4351f4e9f4be5", date_time: "2013-12-03 09:02:00", file_name: "took1.jpg", user_id: pt._id, viewer: [] };
   var photo10 = { _id: "57231f1a30e4351f4e9f4be6", date_time: "2013-12-03 09:03:00", file_name: "took2.jpg", user_id: pt._id, viewer: [] };
   var photo11 = { _id: "57231f1a30e4351f4e9f4be7", date_time: "2013-09-04 09:16:32", file_name: "ludgate1.jpg", user_id: al._id, viewer: [] };
   var photo12 = { _id: "57231f1a30e4351f4e9f4be8", date_time: "2008-10-16 17:12:28", file_name: "kenobi4.jpg", user_id: rk._id, viewer: [] };
   ...
   var userName = function (username) {
      for (var i = 0; i < users.length; i++) {
         if ((users[i].last_name).toLowerCase() === username) {
            return users[i];
         }
      }
      return null
   ...
   var photoModel = function (photo_id) {
      for (var i = 0; i < photos.length; i++) {
         if (photos[i]._id === photo_id) {
            return photos[i];
         }
      }
      return null
   ...
   var findUserByLoginName = function (login_name) {
      return users.filter(function (user) {
         if ((user.last_name).toLowerCase === login_name) {
            return user;
         }
      })
   }
   ...
   var cs142models = {
      ...
      findUserByLoginName: findUserByLoginName
   };
